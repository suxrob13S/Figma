...
function Sidebar() {
  ...
  return (
    /* lg:flex - faqat katta ekranda chiqadi. 
       w-full lg:w-[300px] - mobilda to'liq, kompyuterda 300px.
       hidden lg:flex - mobilda yashirib turamiz (buzilmasligi uchun) */
            ...
            <div key={item.id}>
              ...
              >
                <NavLink to={item.path} className="flex items-center gap-2 flex-1">
                  {/* ICONLARGA TEGILMADI - ORIGINAL HOLATI */}
                  <img
                    src={item.icon}
                    alt=""
